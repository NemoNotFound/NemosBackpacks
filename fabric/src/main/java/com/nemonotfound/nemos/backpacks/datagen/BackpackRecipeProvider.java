    ...
    protected @NotNull RecipeProvider createRecipeProvider(HolderLookup.Provider provider, RecipeOutput recipeOutput) {
        return new RecipeProvider(provider, recipeOutput) {
            ...
            public void buildRecipes() {
                this.shaped(RecipeCategory.TOOLS, BackpackItems.BACKPACK.get())
                        .define('-', Items.STRING)
                ...
                copySmithingUpgradeTemplate(BackpackItems.COPPER_UPGRADE_SMITHING_TEMPLATE.get(), Items.COBBLESTONE);
                backpackSmithingRecipes(BackpackMaterial.STRING, BackpackItems.COPPER_UPGRADE_SMITHING_TEMPLATE.get(), BackpackItemTags.COPPER_TOOL_MATERIALS, "has_copper_ingot");
                
                copySmithingUpgradeTemplate(BackpackItems.IRON_UPGRADE_SMITHING_TEMPLATE.get(), Items.COPPER_INGOT);
                backpackSmithingRecipes(BackpackMaterial.COPPER, BackpackItems.IRON_UPGRADE_SMITHING_TEMPLATE.get(), ItemTags.IRON_TOOL_MATERIALS, "has_iron_ingot");
                
                copySmithingUpgradeTemplate(BackpackItems.GOLD_UPGRADE_SMITHING_TEMPLATE.get(), Items.IRON_INGOT);
                backpackSmithingRecipes(BackpackMaterial.IRON, BackpackItems.GOLD_UPGRADE_SMITHING_TEMPLATE.get(), ItemTags.GOLD_TOOL_MATERIALS, "has_gold_ingot");
                
                copySmithingUpgradeTemplate(BackpackItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE.get(), Items.GOLD_INGOT);
                backpackSmithingRecipes(BackpackMaterial.GOLD, BackpackItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE.get(), ItemTags.DIAMOND_TOOL_MATERIALS, "has_diamond");
