...
public class BackpackMenu extends AbstractContainerMenu {
    ...
    public static BackpackMenu defaultBackpack(int containerId, Inventory playerInventory) {
        return new BackpackMenu(BackpackMenuTypes.DEFAULT_BACKPACK, containerId, playerInventory, 1);
    }
    ...
    public static BackpackMenu defaultBackpack(int containerId, Inventory playerInventory, ItemStack itemStack, Container container) {
        return new BackpackMenu(BackpackMenuTypes.DEFAULT_BACKPACK, containerId, playerInventory, itemStack, container, 1);
    }

    public static BackpackMenu copperBackpack(int containerId, Inventory playerInventory) {
        return new BackpackMenu(BackpackMenuTypes.COPPER_BACKPACK, containerId, playerInventory, 2);
    }
    ...
    public static BackpackMenu copperBackpack(int containerId, Inventory playerInventory, ItemStack itemStack, Container container) {
        return new BackpackMenu(BackpackMenuTypes.COPPER_BACKPACK, containerId, playerInventory, itemStack, container, 2);
    }

    public static BackpackMenu ironBackpack(int containerId, Inventory playerInventory) {
        return new BackpackMenu(BackpackMenuTypes.IRON_BACKPACK, containerId, playerInventory, 3);
    }
    ...
    public static BackpackMenu ironBackpack(int containerId, Inventory playerInventory, ItemStack itemStack, Container container) {
        return new BackpackMenu(BackpackMenuTypes.IRON_BACKPACK, containerId, playerInventory, itemStack, container, 3);
    }

    public static BackpackMenu goldenBackpack(int containerId, Inventory playerInventory) {
        return new BackpackMenu(BackpackMenuTypes.GOLDEN_BACKPACK, containerId, playerInventory, 4);
    }
    ...
    public static BackpackMenu goldenBackpack(int containerId, Inventory playerInventory, ItemStack itemStack, Container container) {
        return new BackpackMenu(BackpackMenuTypes.GOLDEN_BACKPACK, containerId, playerInventory, itemStack, container, 4);
    }

    public static BackpackMenu diamondBackpack(int containerId, Inventory playerInventory) {
        return new BackpackMenu(BackpackMenuTypes.DIAMOND_BACKPACK, containerId, playerInventory, 5);
    }
    ...
    public static BackpackMenu diamondBackpack(int containerId, Inventory playerInventory, ItemStack itemStack, Container container) {
        return new BackpackMenu(BackpackMenuTypes.DIAMOND_BACKPACK, containerId, playerInventory, itemStack, container, 5);
    }

    public static BackpackMenu netheriteBackpack(int containerId, Inventory playerInventory) {
        return new BackpackMenu(BackpackMenuTypes.NETHERITE_BACKPACK, containerId, playerInventory, 6);
    }
    ...
    public static BackpackMenu netheriteBackpack(int containerId, Inventory playerInventory, ItemStack itemStack, Container container) {
        return new BackpackMenu(BackpackMenuTypes.NETHERITE_BACKPACK, containerId, playerInventory, itemStack, container, 6);
    }
    ...
    @Override
    public void clicked(int slotId, int button, @NotNull ContainerInput containerInput, @NotNull Player player) {
        if (!containerInput.equals(ContainerInput.CLONE) && isItemBackpackInUse(slotId, containerInput, button)) {
            return;
        }
    ...
    private boolean isItemBackpackInUse(int slotId, ContainerInput clickType, int button) {
        ...
        if (clickType.equals(ContainerInput.SWAP)) {
    ...
    private boolean isBackpackOpen(ItemStack itemStack) {
        return itemStack.getOrDefault(BackpacksDataComponents.IS_BACKPACK_OPEN, false);
    }
    ...
    public void removed(@NotNull Player player) {
        ...
        itemStack.set(BackpacksDataComponents.IS_BACKPACK_OPEN, false);
    }
