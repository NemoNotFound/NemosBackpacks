...
public class BackpackMenu extends AbstractContainerMenu {
    ...
    public static BackpackMenu defaultBackpack(int containerId, Inventory playerInventory) {
        return new BackpackMenu(BackpackMenuTypes.DEFAULT_BACKPACK.get(), containerId, BackpackMaterial.STRING, playerInventory, 1);
    }
    ...
    public static BackpackMenu defaultBackpack(int containerId, Inventory playerInventory, ItemStack itemStack, Container container) {
        return new BackpackMenu(BackpackMenuTypes.DEFAULT_BACKPACK.get(), containerId, BackpackMaterial.STRING, playerInventory, itemStack, container, 1);
    }

    public static BackpackMenu copperBackpack(int containerId, Inventory playerInventory) {
        return new BackpackMenu(BackpackMenuTypes.COPPER_BACKPACK.get(), containerId, BackpackMaterial.COPPER, playerInventory, 2);
    }
    ...
    public static BackpackMenu copperBackpack(int containerId, Inventory playerInventory, ItemStack itemStack, Container container) {
        return new BackpackMenu(BackpackMenuTypes.COPPER_BACKPACK.get(), containerId, BackpackMaterial.COPPER, playerInventory, itemStack, container, 2);
    }

    public static BackpackMenu ironBackpack(int containerId, Inventory playerInventory) {
        return new BackpackMenu(BackpackMenuTypes.IRON_BACKPACK.get(), containerId, BackpackMaterial.IRON, playerInventory, 3);
    }
    ...
    public static BackpackMenu ironBackpack(int containerId, Inventory playerInventory, ItemStack itemStack, Container container) {
        return new BackpackMenu(BackpackMenuTypes.IRON_BACKPACK.get(), containerId, BackpackMaterial.IRON, playerInventory, itemStack, container, 3);
    }

    public static BackpackMenu goldenBackpack(int containerId, Inventory playerInventory) {
        return new BackpackMenu(BackpackMenuTypes.GOLDEN_BACKPACK.get(), containerId, BackpackMaterial.GOLD, playerInventory, 4);
    }
    ...
    public static BackpackMenu goldenBackpack(int containerId, Inventory playerInventory, ItemStack itemStack, Container container) {
        return new BackpackMenu(BackpackMenuTypes.GOLDEN_BACKPACK.get(), containerId, BackpackMaterial.GOLD, playerInventory, itemStack, container, 4);
    }

    public static BackpackMenu diamondBackpack(int containerId, Inventory playerInventory) {
        return new BackpackMenu(BackpackMenuTypes.DIAMOND_BACKPACK.get(), containerId, BackpackMaterial.DIAMOND, playerInventory, 5);
    }
    ...
    public static BackpackMenu diamondBackpack(int containerId, Inventory playerInventory, ItemStack itemStack, Container container) {
        return new BackpackMenu(BackpackMenuTypes.DIAMOND_BACKPACK.get(), containerId, BackpackMaterial.DIAMOND, playerInventory, itemStack, container, 5);
    }

    public static BackpackMenu netheriteBackpack(int containerId, Inventory playerInventory) {
        return new BackpackMenu(BackpackMenuTypes.NETHERITE_BACKPACK.get(), containerId, BackpackMaterial.NETHERITE, playerInventory, 6);
    }
    ...
    public static BackpackMenu netheriteBackpack(int containerId, Inventory playerInventory, ItemStack itemStack, Container container) {
        return new BackpackMenu(BackpackMenuTypes.NETHERITE_BACKPACK.get(), containerId, BackpackMaterial.NETHERITE, playerInventory, itemStack, container, 6);
    }
